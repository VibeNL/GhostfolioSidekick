...
namespace GhostfolioSidekick.GhostfolioAPI.UnitTests.Strategies
{
	public class DeterminePriceTests
	{
		...
		public async Task Execute_ShouldSetUnitPrice_WhenUnitPriceIsZero()
		{
			...
			// Assert
			holding.Activities.First().UnitPrice.Amount.Should().Be(5000);
		}
		...
		public async Task Execute_ShouldNotSetUnitPrice_WhenUnitPriceIsNotZero()
		{
			...
			// Assert
			holding.Activities.First().UnitPrice.Amount.Should().Be(1000);
		}
		...
		public async Task Execute_ShouldNotSetUnitPrice_WhenSymbolProfileIsNull()
		{
			...
			// Assert
			holding.Activities.First().UnitPrice.Amount.Should().Be(0);
		}
	}
}
