...
{
	public class DummyChatClient() : IWebChatClient
	{
		public ChatClientMetadata Metadata { get; } = new(nameof(WebLLMChatClient));
		...
		public async Task InitializeAsync(IProgress<InitializeProgress> OnProgress)
		{
			...
			OnProgress.Report(new InitializeProgress(0, "Initializing..."));
			await Task.Delay(1000);
			OnProgress.Report(new InitializeProgress(0.5, "Loading..."));
			await Task.Delay(1000);
			OnProgress.Report(new InitializeProgress(1, "Done!"));
		}
	}
}
