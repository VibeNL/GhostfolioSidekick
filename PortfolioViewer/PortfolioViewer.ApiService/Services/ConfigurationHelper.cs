	...
	public class ConfigurationHelper : IConfigurationHelper
	{
		...
		private T ConvertValue<T>(string value)
		{
			...
			return targetType.Name switch
			{
				...
				nameof(DateTime) => (T)(object)DateTime.Parse(value, CultureInfo.InvariantCulture, DateTimeStyles.AdjustToUniversal | DateTimeStyles.AssumeUniversal),
				nameof(DateTimeOffset) => (T)(object)DateTimeOffset.Parse(value, CultureInfo.InvariantCulture, DateTimeStyles.AdjustToUniversal | DateTimeStyles.AssumeUniversal),
