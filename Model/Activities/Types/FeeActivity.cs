...
{
	public record class FeeActivity : BaseActivity<FeeActivity>
	{
		public FeeActivity(
			Account account,
			DateTime dateTime,
		...
		protected override async Task<bool> AreEqualInternal(IExchangeRateService exchangeRateService, FeeActivity otherActivity)
		{
