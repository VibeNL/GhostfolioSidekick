...
namespace GhostfolioSidekick.Database.Migrations
{
    ...
    [Migration("20260114093601_UpdateManualMarketData")]
    partial class UpdateManualMarketData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Market.CurrencyExchangeRate", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Close", "GhostfolioSidekick.Model.Market.CurrencyExchangeRate.Close#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Market.CurrencyExchangeRate.Close#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "High", "GhostfolioSidekick.Model.Market.CurrencyExchangeRate.High#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Market.CurrencyExchangeRate.High#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Low", "GhostfolioSidekick.Model.Market.CurrencyExchangeRate.Low#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Market.CurrencyExchangeRate.Low#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Open", "GhostfolioSidekick.Model.Market.CurrencyExchangeRate.Open#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Market.CurrencyExchangeRate.Open#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Market.MarketData", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Close", "GhostfolioSidekick.Model.Market.MarketData.Close#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Market.MarketData.Close#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "High", "GhostfolioSidekick.Model.Market.MarketData.High#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Market.MarketData.High#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Low", "GhostfolioSidekick.Model.Market.MarketData.Low#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Market.MarketData.Low#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Open", "GhostfolioSidekick.Model.Market.MarketData.Open#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Market.MarketData.Open#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Performance.BalancePrimaryCurrency", b =>
                {
                    ...
                    b.ToTable("BalancePrimaryCurrencies", (string)null);
                });
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Performance.CalculatedSnapshot", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "AverageCostPrice", "GhostfolioSidekick.Model.Performance.CalculatedSnapshot.AverageCostPrice#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Performance.CalculatedSnapshot.AverageCostPrice#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "CurrentUnitPrice", "GhostfolioSidekick.Model.Performance.CalculatedSnapshot.CurrentUnitPrice#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Performance.CalculatedSnapshot.CurrentUnitPrice#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "TotalInvested", "GhostfolioSidekick.Model.Performance.CalculatedSnapshot.TotalInvested#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Performance.CalculatedSnapshot.TotalInvested#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "TotalValue", "GhostfolioSidekick.Model.Performance.CalculatedSnapshot.TotalValue#Money", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty(typeof(Dictionary<string, object>), "Currency", "GhostfolioSidekick.Model.Performance.CalculatedSnapshot.TotalValue#Money.Currency#Currency", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.HasIndex("HoldingAggregatedId", "Date");

                    b.HasIndex("HoldingAggregatedId", "AccountId", "Date")
                        .IsUnique();

                    b.ToTable("CalculatedSnapshots", (string)null);
                });

            modelBuilder.Entity("GhostfolioSidekick.Model.Performance.CalculatedSnapshotPrimaryCurrency", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("CalculatedSnapshotPrimaryCurrencies", (string)null);
                });
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Performance.BalancePrimaryCurrency", b =>
                {
                    b.HasOne("GhostfolioSidekick.Model.Accounts.Account", null)
                        .WithMany("BalancePrimaryCurrency")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Performance.CalculatedSnapshotPrimaryCurrency", b =>
                {
                    b.HasOne("GhostfolioSidekick.Model.Performance.HoldingAggregated", null)
                        .WithMany("CalculatedSnapshotsPrimaryCurrency")
                        .HasForeignKey("HoldingAggregatedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Accounts.Account", b =>
                {
                    ...
                    b.Navigation("BalancePrimaryCurrency");
                });
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Performance.HoldingAggregated", b =>
                {
                    ...
                    b.Navigation("CalculatedSnapshotsPrimaryCurrency");
                });
