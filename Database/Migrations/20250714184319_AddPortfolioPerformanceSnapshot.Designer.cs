...
namespace GhostfolioSidekick.Database.Migrations
{
    ...
    [Migration("20250714184319_AddPortfolioPerformanceSnapshot")]
    partial class AddPortfolioPerformanceSnapshot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Performance.PortfolioPerformanceSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("StartDate", "EndDate", "BaseCurrency", "IsLatest", "Scope", "ScopeIdentifier")
                        .HasDatabaseName("IX_PortfolioPerformanceSnapshot_Latest");

                    b.HasIndex("PortfolioHash", "StartDate", "EndDate", "BaseCurrency", "CalculationType", "Scope", "ScopeIdentifier")
                        .HasDatabaseName("IX_PortfolioPerformanceSnapshot_Lookup");

                    b.ToTable("PortfolioPerformanceSnapshots");
                });
            ...
            modelBuilder.Entity("GhostfolioSidekick.Model.Performance.PortfolioPerformanceSnapshot", b =>
                {
                    b.OwnsOne("GhostfolioSidekick.Model.Portfolio.PortfolioPerformance", "Performance", b1 =>
                        {
                            b1.Property<int>("PortfolioPerformanceSnapshotId")
                                .HasColumnType("INTEGER");
                            ...
                            b1.Property<decimal>("CurrencyImpact")
                                .HasPrecision(18, 8)
                                .HasColumnType("TEXT");
                            ...
                            b1.Property<decimal>("TimeWeightedReturn")
                                .HasPrecision(18, 8)
                                .HasColumnType("TEXT");

                            b1.HasKey("PortfolioPerformanceSnapshotId");

                            b1.ToTable("PortfolioPerformanceSnapshots");

                            b1.WithOwner()
                                .HasForeignKey("PortfolioPerformanceSnapshotId");

                            b1.OwnsOne("GhostfolioSidekick.Model.Money", "FinalValue", b2 =>
                                {
                                    b2.Property<int>("PortfolioPerformanceSnapshotId")
                                        .HasColumnType("INTEGER");
                                    ...
                                    b2.HasKey("PortfolioPerformanceSnapshotId");

                                    b2.ToTable("PortfolioPerformanceSnapshots");

                                    b2.WithOwner()
                                        .HasForeignKey("PortfolioPerformanceSnapshotId");
                                });

                            b1.OwnsOne("GhostfolioSidekick.Model.Money", "InitialValue", b2 =>
                                {
                                    b2.Property<int>("PortfolioPerformanceSnapshotId")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("GhostfolioSidekick.Model.Money", "NetCashFlows", b2 =>
                                {
                                    b2.Property<int>("PortfolioPerformanceSnapshotId")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.OwnsOne("GhostfolioSidekick.Model.Money", "TotalDividends", b2 =>
                                {
                                    b2.Property<int>("PortfolioPerformanceSnapshotId")
                                        .HasColumnType("INTEGER");
                            ...
                            b1.Navigation("FinalValue")
                                .IsRequired();

                            b1.Navigation("InitialValue")
                                .IsRequired();

                            b1.Navigation("NetCashFlows")
                                .IsRequired();

                            b1.Navigation("TotalDividends")
                                .IsRequired();
                        });
