...
namespace GhostfolioSidekick.Model.UnitTests.Activities.Types
{
	public class InterestActivityTests
	{
		...
		public InterestActivityTests()
		{
			...
			activity = new InterestActivity(account, dateTime, amount, transactionId, null, null);
		}
		...
		{
			// Arrange
			var otherActivity = new InterestActivity(activity.Account, activity.Date, activity.Amount, activity.TransactionId, null, null);
		...
		{
			// Arrange
			var otherActivity = new InterestActivity(activity.Account, activity.Date, new Money(Currency.USD, 5), activity.TransactionId, null, null);
