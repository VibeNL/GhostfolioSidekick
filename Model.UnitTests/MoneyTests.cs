...
namespace GhostfolioSidekick.UnitTests.Model
{
	public class MoneyTests
	{
		...
		[Fact]
		public void OperatorEqual_ShouldReturnTrue_WhenSameCurrencyAndAmount()
		{
			// Arrange
			var money1 = new Money(Currency.USD, 100);
			var money2 = new Money(Currency.USD, 100);
		...
		[Fact]
		public void OperatorEqual_ShouldReturnFalse_WhenDifferentCurrency()
		{
			// Arrange
			var money1 = new Money(Currency.USD, 100);
			var money2 = new Money(Currency.EUR, 100);
		...
		[Fact]
		public void OperatorEqual_ShouldReturnFalse_WhenDifferentAmount()
		{
			// Arrange
			var money1 = new Money(Currency.USD, 100);
			var money2 = new Money(Currency.USD, 200);
		...
		[Fact]
		public void OperatorNotEqual_ShouldReturnFalse_WhenSameCurrencyAndAmount()
		{
			// Arrange
			var money1 = new Money(Currency.USD, 100);
			var money2 = new Money(Currency.USD, 100);
		...
		[Fact]
		public void OperatorNotEqual_ShouldReturnTrue_WhenDifferentCurrency()
		{
			// Arrange
			var money1 = new Money(Currency.USD, 100);
			var money2 = new Money(Currency.EUR, 100);
		...
		[Fact]
		public void OperatorNotEqual_ShouldReturnTrue_WhenDifferentAmount()
		{
			// Arrange
			var money1 = new Money(Currency.USD, 100);
			var money2 = new Money(Currency.USD, 200);
