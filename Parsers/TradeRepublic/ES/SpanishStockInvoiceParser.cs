...
{
	public class SpanishStockInvoiceParser : BaseSubParser
	{
		// Original text: "POSICIÓN", "CANTIDAD", "COTIZACIÓN", "IMPORTE"
		private readonly string[] Stock = ["POSICI\u00d3N", "CANTIDAD", "COTIZACI\u00d3N", "IMPORTE"];
