...
{
	public class EnglishOrderConfirmationParser : BaseSubParser
	{
		private readonly string[] CostInformation = ["POSITION", "INTERVALL", "NEXT EXECUTION"];
		...
		protected override TableDefinition[] TableDefinitions
		{
			...
			{
				return [
					new TableDefinition(CostInformation, "Trade", column4, true, new ColumnAlignmentMergeStrategy()), // Cost table is required
				];
			}
		}
