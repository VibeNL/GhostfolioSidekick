...
//    {
//    public class BaaderBankWUM : CSVBaseImporter
//        {
...
//            new HeaderMapping{ DestinationHeader = DestinationHeader.Undefined1, SourceName = "XXX-BELEGU" },
//        };
...
//            {
//            var isSavingsPlan = string.Equals(GetValue(csvReader, DestinationHeader.Undefined1).Trim(), "00000000", StringComparison.InvariantCultureIgnoreCase);
