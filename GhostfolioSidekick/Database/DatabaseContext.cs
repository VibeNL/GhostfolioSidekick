...
namespace GhostfolioSidekick.Database
{
	public class DatabaseContext : DbContext
	{
		...
		public virtual DbSet<AverageUnitPriceAndProfitLoss> AverageUnitPriceAndProfitLoss { get; set; }
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<AverageUnitPriceAndProfitLoss>()
				.HasKey(a => a.Id);

			modelBuilder.Entity<AverageUnitPriceAndProfitLoss>()
				.HasIndex(a => new { a.HoldingId, a.Date })
				.IsUnique();
		}
