	...
	public class BunqParserTests
	{
		...
		public async Task ConvertActivitiesForAccount_SingleDeposit_Converted()
		{
			...
			holdingsAndAccountsCollection.PartialActivities.Should().BeEquivalentTo(
				[PartialActivity.CreateCashDeposit(Currency.EUR, new DateTime(2023, 07, 20, 0, 0, 0, DateTimeKind.Utc), 1000, "20-7-2023 00:00:00_1")]
				);
		}
		...
		public async Task ConvertActivitiesForAccount_SingleWithdrawal_Converted()
		{
			...
			// Assert
			holdingsAndAccountsCollection.PartialActivities.Should().BeEquivalentTo(
				[PartialActivity.CreateCashWithdrawal(Currency.EUR, new DateTime(2023, 07, 20, 0, 0, 0, DateTimeKind.Utc), 100, "20-7-2023 00:00:00_1")]
				);
		}
		...
		public async Task ConvertActivitiesForAccount_SingleInterest_Converted()
		{
			...
			// Assert
			holdingsAndAccountsCollection.PartialActivities.Should().BeEquivalentTo(
				[PartialActivity.CreateInterest(Currency.EUR, new DateTime(2023, 07, 27, 0, 0, 0, DateTimeKind.Utc), 3.5M, "27-7-2023 00:00:00_1")]
				);
		}
		...
		public async Task ConvertActivitiesForAccount_TestMultipleDepositsOn1Day_Converted()
		{
			...
			holdingsAndAccountsCollection.PartialActivities.Should().BeEquivalentTo(
				[PartialActivity.CreateCashDeposit(Currency.EUR, new DateTime(2023, 07, 20, 0, 0, 0, DateTimeKind.Utc), 1000, "20-7-2023 00:00:00_1"),
					PartialActivity.CreateCashDeposit(Currency.EUR, new DateTime(2023, 07, 20, 0, 0, 0, DateTimeKind.Utc), 1000, "20-7-2023 00:00:00_2"),
					PartialActivity.CreateCashDeposit(Currency.EUR, new DateTime(2023, 07, 20, 0, 0, 0, DateTimeKind.Utc), 1000, "20-7-2023 00:00:00_3")]
				);
		}
	}
}