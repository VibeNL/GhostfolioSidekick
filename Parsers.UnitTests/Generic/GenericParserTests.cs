...
namespace GhostfolioSidekick.Parsers.UnitTests.Generic
{
	public class GenericParserTests
	{
			...
			activityManager.PartialActivities.Should().BeEquivalentTo(
				[
					PartialActivity.CreateBuy(
						...
						new[] {
							PartialSymbolIdentifier.CreateGeneric(IdentifierType.Ticker, "NVDA", Currency.USD),
							PartialSymbolIdentifier.CreateGeneric(IdentifierType.Name, "NVIDIA", Currency.USD),
							PartialSymbolIdentifier.CreateGeneric(IdentifierType.ISIN, "US67066G1040", Currency.USD),
						},
						0.0267001000M,
					...
					PartialActivity.CreateBuy(
						...
						new[] {
							new PartialSymbolIdentifier(
								...
								new List<AssetSubClass> { AssetSubClass.Stock }),
							new PartialSymbolIdentifier(
								IdentifierType.Name,
								"NVIDIA",
								Currency.USD,
		...
		[Fact]
		public async Task ConvertActivitiesForAccount_TestFileSingleBuyWithMultipleAssetSubClasses_ParsesAllSubClasses()
		{
			// Arrange
			await parser.ParseActivities("./TestFiles/Generic/BuyOrders/single_buy_with_multiple_subclasses.csv", activityManager, account.Name);
