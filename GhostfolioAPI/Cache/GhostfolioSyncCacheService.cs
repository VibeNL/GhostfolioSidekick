...
/// Reuses the same ExternalDataCacheEntries table as ExternalDataCacheService.
/// </summary>
public class GhostfolioSyncCacheService(IDbContextFactory<DatabaseContext> dbContextFactory) : IGhostfolioSyncCacheService
{
	/// <summary>
