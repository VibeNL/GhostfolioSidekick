...
//			var rawPlatforms = JsonConvert.DeserializeObject<Platform[]>(content);
...
//		private async Task DeleteOrder(Activity order)
//		{
...
//		private Task<string> ConvertToBody(Activity activity)
//		{
//			var o = new JObject();
...
//				o["symbol"] = "Interest";
//			}
//			else if (activity.Type == ActivityType.FEE)
//			{
//				o["symbol"] = "Fee";
//			}
//			else
...
//		private IEnumerable<MergeOrder> MergeOrders(IEnumerable<Activity> ordersFromFiles, IEnumerable<Activity> existingOrders)
//		{
...
//		private bool AreEquals(Activity fo, Activity eo)
//		{
//			return
//				(fo.SymbolProfile?.Symbol == eo.SymbolProfile?.Symbol || fo.Type == ActivityType.INTEREST || fo.Type == ActivityType.FEE) && // Interest & Fee create manual symbols
...
//		private Activity Round(Activity activity)
//		{
