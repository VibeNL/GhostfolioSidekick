...
namespace GhostfolioSidekick.Utilities.UnitTests
{
    public class SemanticMatcherTests
    {
        ...
        {
            int score1 = SemanticMatcher.CalculateSemanticMatchScore(null!, new[] { "AAPL" });
            int score2 = SemanticMatcher.CalculateSemanticMatchScore(new string[0], new[] { "AAPL" });
        ...
        {
            int score1 = SemanticMatcher.CalculateSemanticMatchScore(new[] { "AAPL" }, null!);
            int score2 = SemanticMatcher.CalculateSemanticMatchScore(new[] { "AAPL" }, new string[0]);
            Assert.Equal(0, score1);
            Assert.Equal(0, score2);
        }
